  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
            <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg border border-gray-300" id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <header className="text-center mb-10">
        <h1 className="text-5xl font-bold text-teal-600 mb-1">
          <input
            value={formData.name}
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-teal-600 focus:outline-none focus:border-teal-400 transition duration-200"
      ...
      <section className="mb-8">
        <h3 className="text-3xl font-semibold text-teal-600 mb-2">About Me</h3>
        <textarea
          value={formData.personalDescription}
          onChange={handleChange}
          name="personalDescription"
          readOnly={!isEdit}
          className="w-full h-32 p-4 border border-gray-300 rounded-lg focus:outline-none focus:border-teal-400 transition duration-200"
      ...
      <section className="mb-8">
        <h3 className="text-3xl font-semibold text-teal-600 mb-4">Work Experience</h3>
        {experiences.map((exp, index) => (
          <div key={index} className="mb-4 p-4 border border-gray-300 rounded-lg bg-gray-50 shadow-sm transition duration-200 hover:shadow-md">
            <input
              value={exp.year}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-teal-600 focus:outline-none focus:border-teal-400 transition duration-200 w-full mb-2"
              placeholder="Year"
            />
            <input
              value={exp.title}
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-teal-400 transition duration-200"
              placeholder="Job Description"
            />
            {isEdit && (
              <FaTrash
                onClick={() => removeExperience(index)}
                className="text-red-600 mt-2 cursor-pointer hover:scale-110 transition duration-200"
              />
            )}
          </div>
        ))}
        {isEdit && (
          <div
            ...
            className="text-teal-600 cursor-pointer flex items-center mb-4 hover:underline"
          >
      ...
      {/* Skills Section */}
      <section>
        <h3 className="text-3xl font-semibold text-teal-600 mb-4">Skills</h3>
        {skills.map((skill, index) => (
          <div key={index} className="flex items-center justify-between mb-3 bg-gray-50 p-4 rounded-lg transition duration-200 hover:bg-gray-100">
            <input
              value={skill.title}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-teal-600 focus:outline-none focus:border-teal-400 transition duration-200 w-full"
              placeholder="Skill"
            />
            {isEdit && (
              <FaTrash
                onClick={() => removeSkill(index)}
                className="text-red-600 ml-2 cursor-pointer hover:scale-110 transition duration-200"
              />
            )}
          </div>
        ))}
        {isEdit && (
          <div
            onClick={addSkill}
            className="text-teal-600 cursor-pointer flex items-center hover:underline"
          >
