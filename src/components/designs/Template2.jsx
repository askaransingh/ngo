...
const Template2 = ({
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="max-w-4xl mx-auto border-2 border-primaryDark p-6 rounded-md bg-gradient-to-r from-gray-50 to-white">
        <div className="text-center mb-10">
          ...
          <div className="space-y-2">
            <input
              ...
              type="text"
              className={`text-4xl font-extrabold uppercase tracking-wide text-primaryDark w-full text-center outline-none border-none ${
            ...
            <input
              ...
              type="text"
              className={`text-xl font-medium mt-2 text-gray-600 w-full text-center outline-none border-none ${
                isEdit ? "bg-gray-200" : "bg-transparent"
              }`}
              readOnly={!isEdit}
            />
            <input
              ...
              type="text"
              className={`text-md mt-1 text-gray-500 w-full text-center outline-none border-none ${
                isEdit ? "bg-gray-200" : "bg-transparent"
              }`}
              readOnly={!isEdit}
            />
        ...
        <div className="space-y-8">
          ...
          <div className="w-full">
            <p className="uppercase text-2xl tracking-widest font-bold text-primaryDark">
              Education
            </p>
            <div className="w-full h-1 bg-primaryDark my-4"></div>
            <div className="space-y-3">
              {education?.map((edu, i) => (
                <div key={i} className="space-y-2">
                  <input
                    value={edu.degree}
                    onChange={(e) => handleEducationChange(i, e, "degree")}
                    type="text"
                    className={`font-semibold text-lg text-gray-700 w-full outline-none border-none ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                    readOnly={!isEdit}
                  />
                  <input
                    ...
                    onChange={(e) =>
                      handleEducationChange(i, e, "institution")
                    }
                    type="text"
                    className={`text-md text-gray-500 w-full outline-none border-none ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                    readOnly={!isEdit}
                  />
                  <input
                    value={edu.year}
                    onChange={(e) => handleEducationChange(i, e, "year")}
                    type="text"
                    className={`text-md text-gray-500 w-full outline-none border-none ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
            ...
            <div className="space-y-3">
              {experience?.map((exp, i) => (
                <div key={i} className="space-y-2">
                  <input
                    value={exp.jobTitle}
                    onChange={(e) => handleExperienceChange(i, e, "jobTitle")}
                    type="text"
                    className={`font-semibold text-lg text-gray-700 w-full outline-none border-none ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                  ...
                  <input
                    value={exp.company}
                    onChange={(e) => handleExperienceChange(i, e, "company")}
                    type="text"
                    className={`text-md text-gray-500 w-full outline-none border-none ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                  ...
                  <input
                    value={exp.year}
                    onChange={(e) => handleExperienceChange(i, e, "year")}
                    type="text"
                    className={`text-md text-gray-500 w-full outline-none border-none ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleExperienceChange(i, e, "description")
                    }
                    className={`text-sm text-gray-600 w-full outline-none border-none ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                    readOnly={!isEdit}
                  />
          ...
          <div className="w-full">
            ...
            <div className="w-full flex flex-wrap items-center justify-start gap-6">
                      ...
                      <div className="w-full flex items-center justify-between">
                        <div className="flex items-center justify-center">
                          <input
                            ...
                            name="title"
                            type="text"
                            className={`outline-none border-none text-lg tracking-wide capitalize font-semibold text-primaryDark w-full ${
                              isEdit ? "bg-gray-200" : "bg-transparent"
                            }`}
                            readOnly={!isEdit}
                          />
                        ...
                        <AnimatePresence>
                          {isEdit && (
                            ...
                            >
                              <FaTrash className="text-lg text-primaryDark" />
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </div>
                      <div className="relative mt-2 h-3 w-full bg-gray-200 rounded-md">
                        <div
                          className="absolute h-3 left-0 top-0 bg-primaryDark rounded-md"
                          style={{
                            width: `${skill.percentage || 50}%`,
                          }}
                        ></div>
                      </div>
                    </motion.div>
              ...
              {isEdit && (
                <motion.div
                  {...opacityINOut(skills.length + 1)}
                  className="flex flex-col items-center gap-2 justify-center cursor-pointer w-40 h-28 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200 duration-300"
                  onClick={addSkill}
                >
                  <FaPlus className="text-2xl text-primaryDark" />
                  <span className="font-medium text-gray-600">Add Skill</span>
                </motion.div>
              )}
            </div>
          </div>
