...
const Template1 = ({}) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
        <div className="w-full h-auto bg-gray-50 p-8 font-sans border rounded-lg shadow-md" id="resume"
            ref={resumeRef}>
      ...
      <div className="text-center mb-6">
        <h1 className="text-5xl font-bold text-gray-800">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-gray-400 focus:border-blue-400 w-full"
        ...
        <div className="mt-4">
          ...
          <input
            ...
            type="tel"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-gray-400 focus:border-blue-400 w-full mt-2"
      ...
      {/* About Me Section */}
      <div className="bg-white p-6 mb-6 border border-gray-300 rounded-lg shadow-sm">
        <h3 className="text-3xl font-semibold text-gray-800 mb-3">About Me</h3>
        <textarea
      ...
      <div className="bg-white p-6 mb-6 border border-gray-300 rounded-lg shadow-sm">
        <h3 className="text-3xl font-semibold text-gray-800 mb-3">Work Experience</h3>
          ...
          <div key={index} className="mb-4">
            <div className="flex flex-col lg:flex-row justify-between items-center mb-2">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="bg-transparent border-b-2 border-gray-400 focus:border-blue-400 w-full lg:w-1/4"
                placeholder="Year"
              />
              <input
                value={exp.title}
                ...
                type="text"
                readOnly={!isEdit}
                className="bg-transparent border-b-2 border-gray-400 focus:border-blue-400 w-full lg:w-2/3 mt-2 lg:mt-0"
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 mt-2 border border-gray-400 rounded-lg focus:border-blue-400 outline-none"
      ...
      <div className="bg-white p-6 border border-gray-300 rounded-lg shadow-sm">
        <h3 className="text-3xl font-semibold text-gray-800 mb-3">Skills</h3>
          ...
          {skills.map((skill, index) => (
            <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-sm">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="bg-transparent border-b-2 border-gray-400 focus:border-blue-400 w-full mb-2"
                placeholder="Skill"
              />
