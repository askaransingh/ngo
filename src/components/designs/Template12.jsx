    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-green-500">
        <div className="flex flex-col items-start">
          <h1 className="text-5xl font-bold text-green-700">{formData.name}</h1>
          <p className="text-xl text-gray-600 italic">{formData.professionalTitle}</p>

          {/* About Me */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-green-600">About Me</p>
            <textarea
              readOnly={!isEdit}
              className={`w-full p-3 border rounded-lg text-gray-600 ${isEdit ? "bg-green-50" : "bg-white"}`}
          ...
          {/* Experience */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-green-600">Work Experience</p>
            <div className="mt-4">
              <AnimatePresence>
                {experiences.map((exp, i) => (
                  ...
                  >
                    <textarea
                      ...
                      name="year"
                      readOnly={!isEdit}
                      className={`w-1/4 p-3 border rounded-lg text-gray-600 ${isEdit ? "bg-green-50" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
              ...
              {isEdit && (
                <div className="flex justify-end mt-2">
                  <FaPlus className="text-green-600 cursor-pointer" onClick={addExperience} />
                </div>
              )}
            </div>
          </div>
          ...
          {/* Skills */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-green-600">Skills</p>
            <div className="mt-4 flex flex-wrap gap-4">
                ...
                {skills.map((skill, i) => (
                  <motion.div key={i} className="flex items-center w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    <textarea
                      ...
                      name="title"
                      readOnly={!isEdit}
                      className={`flex-1 p-3 border rounded-lg text-gray-600 ${isEdit ? "bg-green-50" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
                    <textarea
              ...
              {isEdit && (
                <div className="w-full flex justify-center mt-2">
                  <FaPlus className="text-green-600 cursor-pointer" onClick={addSkill} />
                </div>
              )}
            </div>
          </div>
