      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
  <div className="w-full min-h-screen bg-gray-100 p-10 font-sans" id="resume"
            ref={resumeRef}>
        ...
        <div className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:space-x-8">
          <div className="flex-1">
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-4xl font-bold bg-transparent border-b-2 border-white focus:border-blue-400 w-full text-center lg:text-left"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-lg text-yellow-400 bg-transparent border-b-2 border-white focus:border-blue-400 w-full text-center lg:text-left mt-2"
          ...
          <div className="flex-1 text-center lg:text-right">
            <input
              ...
              type="email"
              readOnly={!isEdit}
              className="text-sm bg-transparent border-b-2 border-white focus:border-blue-400 w-full"
              placeholder="Email"
            />
            <input
              ...
              type="tel"
              readOnly={!isEdit}
              className="text-sm bg-transparent border-b-2 border-white focus:border-blue-400 w-full mt-2"
      ...
      <div className="bg-white p-6 shadow-md rounded-lg mb-8">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          className="w-full h-24 p-4 bg-gray-50 border-2 border-gray-300 rounded-lg focus:border-blue-400 outline-none"
      ...
      <div className="bg-white p-6 shadow-md rounded-lg mb-8">
        ...
        {experiences.map((exp, index) => (
          <div key={index} className="bg-gray-50 p-4 mb-6 rounded-lg shadow-sm">
            <div className="flex flex-col lg:flex-row items-center justify-between">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-semibold bg-transparent border-b-2 border-gray-300 focus:border-blue-400 w-full lg:w-1/4 mb-2 lg:mb-0"
                placeholder="Year"
              />
              <input
                value={exp.title}
                ...
                type="text"
                readOnly={!isEdit}
                className="text-xl font-bold bg-transparent border-b-2 border-gray-300 focus:border-blue-400 w-full lg:w-2/3 mb-2 lg:mb-0"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-lg bg-transparent border-b-2 border-gray-300 focus:border-blue-400 w-full mt-2 mb-4"
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-20 p-3 bg-gray-50 border-2 border-gray-300 rounded-lg focus:border-blue-400"
        ...
        {isEdit && (
          <div
            ...
            className="text-blue-500 cursor-pointer flex items-center mt-4"
          >
          ...
          {skills.map((skill, index) => (
            <div key={index} className="bg-gray-50 p-4 rounded-lg shadow-sm">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-bold bg-transparent border-b-2 border-gray-300 focus:border-blue-400 w-full"
                placeholder="Skill"
              />
              ...
              {isEdit && (
                <input
                  ...
                  type="number"
                  readOnly={!isEdit}
                  className="mt-2 bg-transparent border-b-2 border-gray-300 focus:border-blue-400 w-full"
