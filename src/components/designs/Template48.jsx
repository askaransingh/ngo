  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
           <div className="max-w-4xl mx-auto p-8 bg-gray-100 rounded-lg shadow-lg border border-gray-300"    id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <header className="text-center mb-12">
        <h1 className="text-5xl font-bold text-indigo-700 mb-2">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b border-indigo-700 focus:outline-none focus:border-indigo-500"
      ...
      <section className="mb-8">
        <h3 className="text-3xl font-semibold text-indigo-700 mb-2">About Me</h3>
        <textarea
          value={formData.personalDescription}
          onChange={handleChange}
          name="personalDescription"
          readOnly={!isEdit}
          className="w-full h-32 p-4 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
      ...
      <section className="mb-8">
        <h3 className="text-3xl font-semibold text-indigo-700 mb-4">Work Experience</h3>
        {experiences.map((exp, index) => (
          <div key={index} className="mb-4 p-5 border border-gray-300 rounded-lg bg-white shadow-sm">
            <input
              value={exp.year}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b border-indigo-700 focus:outline-none focus:border-indigo-500 w-full mb-2"
              placeholder="Year"
            />
            <input
              value={exp.title}
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
        ...
        {isEdit && (
          <div
            ...
            className="text-indigo-700 cursor-pointer flex items-center mb-4"
          >
      ...
      {/* Skills Section */}
      <section>
        <h3 className="text-3xl font-semibold text-indigo-700 mb-4">Skills</h3>
        {skills.map((skill, index) => (
          <div key={index} className="flex items-center justify-between mb-4 bg-gray-200 p-3 rounded-lg">
            <input
              value={skill.title}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b border-indigo-700 focus:outline-none focus:border-indigo-500 w-full"
              placeholder="Skill"
            />
            {isEdit && (
              <FaTrash
        ...
        {isEdit && (
          <div
            onClick={addSkill}
            className="text-indigo-700 cursor-pointer flex items-center"
          >
