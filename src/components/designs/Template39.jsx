      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
    <div className="w-full h-auto bg-gray-100 p-6 font-sans" id="resume"
            ref={resumeRef}>
        ...
        <div className="flex flex-col items-center space-y-4 lg:flex-row lg:justify-between">
          <div className="text-center lg:text-left">
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-4xl font-bold bg-transparent border-b-2 border-white focus:border-blue-400 w-full"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-xl text-yellow-400 bg-transparent border-b-2 border-gray-300 focus:border-blue-400 w-full mt-1"
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg mb-6">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          className="w-full h-32 p-4 bg-gray-50 border-2 border-gray-300 rounded-lg focus:border-blue-400 outline-none"
          ...
          <div key={index} className="bg-gray-100 p-4 mb-4 rounded-lg shadow-sm">
            <div className="flex flex-col lg:flex-row justify-between items-center mb-2">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-semibold bg-transparent border-b-2 border-gray-400 focus:border-blue-400 outline-none w-full lg:w-1/4"
                placeholder="Year"
              />
              <input
                value={exp.title}
                ...
                type="text"
                readOnly={!isEdit}
                className="text-xl font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-400 outline-none w-full lg:w-2/3 ml-2"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-lg bg-transparent border-b-2 border-gray-400 focus:border-blue-400 outline-none w-full mb-2"
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-20 p-3 bg-gray-50 border-2 border-gray-300 rounded-lg focus:border-blue-400 outline-none"
          ...
          {skills.map((skill, index) => (
            <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-sm">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-400 outline-none w-full mb-2"
                placeholder="Skill"
              />
              ...
              {isEdit && (
                <input
                  ...
                  type="number"
                  readOnly={!isEdit}
                  className="text-lg mt-2 bg-transparent border-b-2 border-gray-400 focus:border-blue-400 outline-none"
