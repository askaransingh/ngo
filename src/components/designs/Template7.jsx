      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
                    <div className="bg-gradient-to-r from-blue-50 via-white to-blue-100 min-h-screen p-12 text-gray-900" id="resume"
            ref={resumeRef}>
      {/* Header */}
      <div className="w-full max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-10">
        <div className="flex flex-col items-center justify-center">
          <input
            ...
            type="text"
            readOnly={true}
            className={`text-4xl font-extrabold tracking-wide text-blue-700 uppercase ${isEdit && "bg-blue-100"}`}
          />
          <input
            ...
            type="text"
            readOnly={true}
            className={`text-xl tracking-widest text-gray-600 uppercase mt-2 ${isEdit && "bg-blue-100"}`}
          />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
          <div>
            <p className="text-2xl font-bold text-blue-700">About Me</p>
            <textarea
              readOnly={true}
              className={`mt-4 p-6 w-full text-base bg-blue-50 rounded-md shadow-sm ${isEdit && "bg-blue-100"}`}
          ...
          {/* Experience */}
          <div>
            <p className="text-2xl font-bold text-blue-700">Work Experience</p>
            <div className="w-full h-1 bg-blue-200 my-3"></div>
            <div className="space-y-4">
              <AnimatePresence>
                {experiences &&
                  experiences?.map((exp, i) => (
                    <motion.div {...opacityINOut(i)} className="grid grid-cols-12 gap-6" key={i}>
                      <div className="col-span-3">
                        <input
                          ...
                          type="text"
                          readOnly={true}
                          className={`w-full text-base font-bold text-blue-600 uppercase ${isEdit && "bg-blue-100"}`}
                        />
                      </div>
                      <div className="col-span-9">
                        ...
                        <input
                          ...
                          type="text"
                          readOnly={true}
                          className={`text-xl font-semibold text-gray-900 ${isEdit && "bg-blue-100"}`}
                        />
                        <input
                          ...
                          type="text"
                          readOnly={true}
                          className={`text-sm text-gray-600 mt-1 ${isEdit && "bg-blue-100"}`}
                        />
                        <textarea
                          readOnly={true}
                          className={`text-sm text-gray-600 mt-2 w-full bg-blue-50 rounded-md shadow-sm ${isEdit ? "bg-blue-100" : "bg-blue-50"}`}
                          name="description"
        ...
        {/* Skills */}
        <div className="mt-8">
          <p className="text-2xl font-bold text-blue-700">Skills</p>
          <div className="w-full h-1 bg-blue-200 my-3"></div>
              ...
              {skills &&
                skills?.map((skill, i) => (
                  <motion.div
                    key={i}
                    {...opacityINOut(i)}
                    className="p-4 bg-blue-50 rounded-lg shadow-lg"
                  >
                    <div className="flex items-center justify-between">
                      <input
                        ...
                        type="text"
                        readOnly={true}
                        className={`text-base font-semibold text-gray-700 ${isEdit && "bg-blue-100"}`}
                      />
                      {isEdit && (
                        <motion.div
                          {...FadeInOutWIthOpacity}
                    ...
                    <div className="relative mt-2 w-full h-2 bg-blue-200 rounded-full">
                      <div
