      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          <div className="flex items-center justify-end w-full gap-12 mb-4">
            ...
            <div className="bg-gray-100 text-gray-900 min-h-screen p-8"  id="resume"
            ref={resumeRef}>
              {/* Header */}
              <div className="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
                <div className="flex items-center justify-between">
                  <input
                    ...
                    type="text"
                    readOnly={true}
                    className={`text-3xl font-bold uppercase text-txtPrimary ${
                      isEdit && "bg-gray-200"
                    }`}
                  />
                  <input
                    ...
                    type="text"
                    readOnly={true}
                    className={`text-lg uppercase tracking-widest text-gray-600 ${
                      isEdit && "bg-gray-200"
                    }`}
                  />
                </div>
                ...
                <div className="mt-6">
                  ...
                  <textarea
                    readOnly={true}
                    className={`mt-2 p-4 w-full text-base bg-gray-50 rounded-md shadow-sm ${
                      isEdit ? "bg-gray-200" : "bg-gray-50"
                    }`}
                          ...
                          >
                            <div className="col-span-3">
                              <input
                                ...
                                type="text"
                                readOnly={true}
                                className={`w-full text-base font-semibold uppercase text-gray-700 ${
                                  isEdit && "bg-gray-200"
                                }`}
                              />
                            </div>
                            <div className="col-span-9">
                              ...
                              <textarea
                                readOnly={true}
                                className={`text-sm text-gray-700 mt-2 w-full bg-gray-50 rounded-md shadow-sm ${
                                  isEdit ? "bg-gray-200" : "bg-gray-50"
                                }`}
                                name="description"
                ...
                {/* Skills */}
                <div className="mt-6">
                  <p className="text-xl font-semibold text-gray-800">Skills</p>
                  <div className="w-full h-1 bg-gray-300 my-3"></div>
                      ...
                      {skills &&
                        skills?.map((skill, i) => (
                          ...
                          >
                            ...
                            <div className="relative mt-2 w-full h-1 bg-gray-300 rounded-full">
                              <div
