      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
     <div className="w-full h-auto bg-gray-100 text-gray-800 p-10 space-y-12" id="resume"
            ref={resumeRef}>

{/* Header Section */}
<div className="w-full flex flex-col md:flex-row justify-between items-center md:items-start space-y-6 md:space-y-0 bg-white p-8 rounded-lg shadow-lg">
  <div className="md:w-2/3 w-full space-y-3">
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="bg-transparent text-4xl font-extrabold w-full border-b-4 border-gray-400 focus:border-indigo-600 outline-none"
    />
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="bg-transparent text-xl font-medium w-full text-indigo-600 border-b-2 border-gray-300 focus:border-indigo-600 outline-none"
    />
  </div>
  <div className="md:w-1/3 w-full space-y-2">
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="bg-transparent text-lg w-full text-gray-600 border-b-2 border-gray-300 focus:border-indigo-600 outline-none"
    />
    <input
...
<div className="w-full bg-white p-8 rounded-lg shadow-lg">
  ...
  <textarea
    ...
    readOnly={!isEdit}
    rows="5"
    className="w-full p-4 bg-gray-100 text-lg rounded-md border-2 border-gray-300 focus:border-indigo-600 outline-none"
  ></textarea>
</div>

{/* Work Experience Section */}
<div className="w-full bg-white p-8 rounded-lg shadow-lg">
  <h2 className="text-3xl font-bold mb-4 text-indigo-700">Work Experience</h2>
  {experiences.map((exp, i) => (
    <div key={i} className="w-full flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8 bg-gray-100 p-6 rounded-md shadow-md mb-6">
      <div className="lg:w-1/4 w-full">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-lg font-bold text-indigo-700 border-b-2 border-gray-400 focus:border-indigo-600 outline-none"
        />
      </div>
      <div className="lg:w-3/4 w-full space-y-4 relative">
        {isEdit && (
          <FaTrash
        ...
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-xl font-bold border-b-2 border-gray-400 focus:border-indigo-600 outline-none"
        />
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-lg text-gray-500 border-b-2 border-gray-300 focus:border-indigo-600 outline-none"
        />
        <textarea
          ...
          readOnly={!isEdit}
          rows="3"
          className="w-full bg-gray-200 p-4 text-gray-700 rounded-md border-2 border-gray-300 focus:border-indigo-600 outline-none"
        ></textarea>
      </div>
    </div>
  ))}
  {isEdit && (
    <div
      ...
      className="cursor-pointer w-full text-center py-2 text-indigo-600"
    >
...
<div className="w-full bg-white p-8 rounded-lg shadow-lg">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {skills.map((skill, i) => (
      <div key={i} className="bg-gray-100 p-4 rounded-md shadow-md relative">
        <input
          value={skill.title}
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-lg font-semibold border-b-2 border-gray-400 focus:border-indigo-600 outline-none mb-2"
        />
        ...
        {isEdit && (
          <input
            ...
            name="percentage"
            type="text"
            className="w-full bg-transparent text-lg font-semibold mt-2 border-b-2 border-gray-400 focus:border-indigo-600 outline-none"
          />
        )}
        {isEdit && (
          <FaTrash
