      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
            <div className="bg-gray-100 min-h-screen p-8 text-gray-900" id="resume"
            ref={resumeRef}>
      {/* Header */}
      <div className="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-xl p-10">
        <div className="flex flex-col items-center justify-center border-b-4 border-gray-300 pb-8 mb-6">
          <input
            value={formData.name}
            ...
            type="text"
            readOnly={true}
            className={`text-5xl font-bold text-gray-800 uppercase tracking-wider mb-3 ${isEdit && "bg-gray-100"}`}
          />
          <input
            ...
            type="text"
            readOnly={true}
            className={`text-lg tracking-wide text-gray-500 uppercase ${isEdit && "bg-gray-100"}`}
          />
        </div>

        {/* About Me and Work Experience - Two-Column Layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
          <div className="border-l-4 border-blue-600 pl-4">
            <p className="text-2xl font-semibold text-blue-600 mb-4">About Me</p>
            <textarea
              readOnly={true}
              className={`p-6 w-full text-base leading-relaxed bg-gray-50 border border-gray-300 rounded-md shadow-sm ${isEdit && "bg-gray-100"}`}
          ...
          <div className="border-l-4 border-blue-600 pl-4">
            <p className="text-2xl font-semibold text-blue-600 mb-4">Work Experience</p>
                    ...
                    <motion.div {...opacityINOut(i)} className="grid grid-cols-12 gap-4" key={i}>
                      <div className="col-span-3">
                        <input
                          ...
                          type="text"
                          readOnly={true}
                          className={`w-full text-base font-bold text-gray-700 uppercase bg-gray-50 ${isEdit && "bg-gray-100"}`}
                        />
                      </div>
                      <div className="col-span-9">
                        {isEdit && (
                          ...
                          >
                            <FaTrash className="text-lg text-blue-600" />
                          </motion.div>
                        )}
                        <input
                          value={exp.title}
                          ...
                          type="text"
                          readOnly={true}
                          className={`text-xl font-bold text-gray-800 ${isEdit && "bg-gray-100"}`}
                        />
                        <input
                        ...
                        <textarea
                          readOnly={true}
                          className={`text-sm text-gray-600 mt-2 w-full bg-gray-50 border border-gray-300 rounded-md shadow-sm ${isEdit ? "bg-gray-100" : "bg-gray-50"}`}
                          name="description"
        ...
        {/* Skills */}
        <div className="border-l-4 border-blue-600 pl-4">
          <p className="text-2xl font-semibold text-blue-600 mb-4">Skills</p>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <input
                        ...
                        type="text"
                        readOnly={true}
                        className={`text-base font-semibold text-gray-700 ${isEdit && "bg-gray-100"}`}
                      />
                      {isEdit && (
                        <motion.div
                          {...FadeInOutWIthOpacity}
