    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
             <div className="bg-gray-200 p-6 rounded-lg shadow-lg"        id="resume"
            ref={resumeRef}>
      <div className="bg-white p-5 rounded-lg shadow-md border border-gray-300">
        <div className="flex flex-col items-start">
          ...
          <p className="text-xl text-gray-800 font-semibold">{formData.professionalTitle}</p>

          {/* About Me */}
          <div className="w-full mt-6">
            <p className="uppercase text-lg font-bold text-blue-600">About Me</p>
            <textarea
              readOnly={!isEdit}
          ...
          {/* Experience */}
          <div className="w-full mt-6">
            <p className="uppercase text-lg font-bold text-blue-600">Work Experience</p>
            <div className="mt-4">
              <AnimatePresence>
                {experiences.map((exp, i) => (
                  ...
                  >
                    <textarea
                      ...
                      name="year"
                      readOnly={!isEdit}
                      className={`w-1/4 p-3 border rounded-lg text-gray-700 bg-green-100 ${isEdit ? "border-green-500" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
                    <div className="flex-1">
                      <textarea
                        ...
                        name="title"
                        readOnly={!isEdit}
                        className={`w-full p-3 border rounded-lg text-gray-700 bg-yellow-100 ${isEdit ? "border-yellow-500" : "bg-white"}`}
                        style={{ resize: "none" }}
                      />
                      <textarea
                        ...
                        readOnly={!isEdit}
                        className={`w-full p-3 border rounded-lg text-gray-700 bg-orange-100 ${isEdit ? "border-orange-500" : "bg-white"}`}
                        style={{ resize: "none" }}
                      />
                      <textarea
          ...
          {/* Skills */}
          <div className="w-full mt-6">
            <p className="uppercase text-lg font-bold text-blue-600">Skills</p>
                ...
                {skills.map((skill, i) => (
                  <motion.div key={i} className="flex items-center w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    ...
                    <textarea
                      ...
                      name="percentage"
                      readOnly={!isEdit}
                      className={`w-1/4 p-3 border rounded-lg text-gray-700 bg-teal-100 ${isEdit ? "border-teal-500" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
                    {isEdit && (
