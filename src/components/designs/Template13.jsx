    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="bg-white p-5 rounded-lg shadow-md">
        <div className="flex flex-col items-start">
          ...
          <p className="text-xl text-gray-600 font-medium">{formData.professionalTitle}</p>

          {/* About Me */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-blue-600">About Me</p>
            <textarea
              readOnly={!isEdit}
              className={`w-full p-3 border rounded-lg text-gray-700 ${isEdit ? "bg-blue-50" : "bg-white"}`}
          ...
          {/* Experience */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-blue-600">Work Experience</p>
            <div className="mt-4">
              <AnimatePresence>
                {experiences.map((exp, i) => (
                  ...
                  >
                    <textarea
                      ...
                      name="year"
                      readOnly={!isEdit}
                      className={`w-1/4 p-3 border rounded-lg text-gray-700 ${isEdit ? "bg-blue-50" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
          ...
          {/* Skills */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-blue-600">Skills</p>
                ...
                {skills.map((skill, i) => (
                  <motion.div key={i} className="flex items-center w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    <textarea
                      ...
                      name="title"
                      readOnly={!isEdit}
                      className={`flex-1 p-3 border rounded-lg text-gray-700 ${isEdit ? "bg-blue-50" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
                    <textarea
