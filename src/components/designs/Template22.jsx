  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
            <div className="w-full h-auto bg-white text-gray-800 p-10" id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <div className="flex flex-col items-center">
        <div className="w-full flex justify-between mb-4">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className={`text-4xl font-bold bg-transparent outline-none w-2/3 ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
          ...
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className={`text-xl font-medium bg-transparent outline-none w-1/3 text-right ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
        ...
        <div className="w-full text-center mb-2">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className={`text-sm bg-transparent outline-none ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
      ...
      <div className="mt-8">
        ...
        <textarea
          readOnly={!isEdit}
          className={`w-full bg-transparent outline-none border border-gray-300 p-2 rounded ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
                ...
                >
                  <div className="w-1/4">
                    <input
                      ...
                      type="text"
                      readOnly={!isEdit}
                      className={`outline-none bg-transparent w-full ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
                      placeholder="Year"
                    />
                  </div>
                  <div className="w-3/4">
                    <input
                      ...
                      type="text"
                      readOnly={!isEdit}
                      className={`text-lg font-semibold bg-transparent outline-none w-full ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
                    ...
                    <input
                      ...
                      type="text"
                      readOnly={!isEdit}
                      className={`text-sm bg-transparent outline-none w-full mt-1 ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
                      placeholder="Company, Location"
                    />
                    <textarea
                      readOnly={!isEdit}
                      className={`text-sm bg-transparent outline-none w-full mt-3 ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
                      name="description"
              ...
              skills.map((skill, i) => (
                ...
                >
                  <input
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className={`text-sm font-semibold bg-transparent outline-none w-2/3 ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
                    placeholder="Skill"
                  />
                  <input
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className={`text-sm bg-transparent outline-none w-1/3 text-right ${isEdit ? "bg-gray-100" : "bg-transparent"}`}
                    placeholder="%"
                  />
                  {isEdit && (
                    <FaTrash
