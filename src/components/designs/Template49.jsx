  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
        <div className="max-w-4xl mx-auto p-10 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg shadow-md border border-gray-300"  id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <header className="text-center mb-12">
        <h1 className="text-6xl font-bold text-blue-800 mb-2">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-blue-800 focus:outline-none focus:border-blue-500 transition duration-200"
      ...
      <section className="mb-10">
        <h3 className="text-4xl font-semibold text-blue-800 mb-3">About Me</h3>
        <textarea
          value={formData.personalDescription}
          onChange={handleChange}
          name="personalDescription"
          readOnly={!isEdit}
          className="w-full h-40 p-4 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-200"
      ...
      <section className="mb-10">
        <h3 className="text-4xl font-semibold text-blue-800 mb-4">Work Experience</h3>
        {experiences.map((exp, index) => (
          <div key={index} className="mb-6 p-5 border border-gray-300 rounded-lg bg-white shadow-sm transition duration-200 hover:shadow-md">
            <input
              value={exp.year}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-blue-800 focus:outline-none focus:border-blue-500 transition duration-200 w-full mb-2"
              placeholder="Year"
            />
            <input
              value={exp.title}
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-200"
        ...
        {isEdit && (
          <div
            ...
            className="text-blue-700 cursor-pointer flex items-center mb-4 hover:underline"
          >
      ...
      {/* Skills Section */}
      <section>
        <h3 className="text-4xl font-semibold text-blue-800 mb-4">Skills</h3>
        {skills.map((skill, index) => (
          <div key={index} className="flex items-center justify-between mb-4 bg-blue-50 p-4 rounded-lg transition duration-200 hover:bg-blue-100">
            <input
              value={skill.title}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-blue-800 focus:outline-none focus:border-blue-500 transition duration-200 w-full"
              placeholder="Skill"
            />
            {isEdit && (
              <FaTrash
        ...
        {isEdit && (
          <div
            onClick={addSkill}
            className="text-blue-700 cursor-pointer flex items-center hover:underline"
          >
