      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
           <div className="w-full h-auto bg-white text-gray-900 p-10" id="resume"
            ref={resumeRef}>

{/* Header Section */}
<div className="w-full flex flex-col lg:flex-row justify-between items-center bg-gray-100 p-8 rounded-lg shadow-lg">
  <div className="lg:w-2/3 w-full mb-4 lg:mb-0">
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="bg-transparent text-4xl font-extrabold w-full border-b-2 border-gray-300 focus:border-indigo-500 outline-none mb-4"
    />
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="bg-transparent text-xl w-full text-indigo-700 border-b-2 border-gray-300 focus:border-indigo-500 outline-none"
    />
  </div>
  <div className="lg:w-1/3 w-full text-right">
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="bg-transparent text-lg w-full mb-2 text-gray-500 outline-none border-b-2 border-gray-300 focus:border-indigo-500"
    />
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="bg-transparent text-lg w-full text-gray-500 outline-none border-b-2 border-gray-300 focus:border-indigo-500"
    />
  </div>
</div>
...
<div className="w-full mt-8">
  ...
  <textarea
    ...
    readOnly={!isEdit}
    rows="5"
    className="w-full p-4 bg-gray-100 text-lg shadow-md rounded-lg border-2 border-gray-300 focus:border-indigo-500 outline-none"
  ></textarea>
</div>

{/* Work Experience Section */}
<div className="w-full mt-10">
  <h2 className="text-3xl font-semibold mb-2">Work Experience</h2>
  {experiences.map((exp, i) => (
    <div key={i} className="w-full flex flex-col md:flex-row bg-gray-50 p-4 shadow-md rounded-lg mb-4">
      <div className="md:w-1/4 w-full mb-4 md:mb-0">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-lg font-semibold text-indigo-700 border-b-2 border-gray-300 focus:border-indigo-500 outline-none"
        />
      </div>
      <div className="md:w-3/4 w-full relative">
        {isEdit && (
          <FaTrash
            ...
            className="cursor-pointer absolute right-0 top-0 text-red-500"
          />
        )}
        <input
          value={exp.title}
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-2xl font-bold border-b-2 border-gray-300 focus:border-indigo-500 outline-none mb-2"
        />
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-lg text-gray-500 border-b-2 border-gray-300 focus:border-indigo-500 outline-none"
        />
        <textarea
          ...
          readOnly={!isEdit}
          rows="3"
          className="w-full mt-2 bg-gray-100 p-4 text-gray-600 shadow-md rounded-lg border-2 border-gray-300 focus:border-indigo-500 outline-none"
        ></textarea>
      </div>
    </div>
  ))}
  {isEdit && (
    ...
    >
      <FaPlus className="text-lg text-indigo-700" />
    </div>
  )}
</div>
...
<div className="w-full mt-10">
  ...
  <div className="grid grid-cols-2 gap-4">
    {skills.map((skill, i) => (
      <div key={i} className="bg-gray-100 p-4 shadow-md rounded-lg">
        <input
          value={skill.title}
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full bg-transparent text-xl font-semibold border-b-2 border-gray-300 focus:border-indigo-500 outline-none mb-2"
        />
        <div className="w-full bg-gray-300 h-3 rounded-lg mt-2">
          <div
        ...
        {isEdit && (
          <input
            ...
            name="percentage"
            type="text"
            className="w-full bg-transparent text-lg font-semibold mt-2 outline-none border-b-2 border-gray-300 focus:border-indigo-500"
          />
        )}
        {isEdit && (
          <FaTrash
            onClick={() => removeSkill(i)}
            className="cursor-pointer text-red-500 w-full text-right mt-2"
          />
        )}
      </div>
    ))}
