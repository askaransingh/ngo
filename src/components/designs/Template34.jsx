      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
             <div className="w-full h-auto bg-gray-200 p-12 font-sans"  id="resume"
            ref={resumeRef}>

{/* Header Section */}
<div className="flex flex-col items-center bg-white p-6 shadow-md rounded-lg mb-8 space-y-6 lg:space-y-0 lg:flex-row justify-between lg:items-start">
  <div className="lg:w-2/3 flex flex-col items-center lg:items-start">
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="text-4xl font-bold text-gray-800 bg-transparent border-b-2 border-gray-400 focus:border-blue-500 w-full outline-none"
    ...
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="text-xl text-blue-700 mt-4 bg-transparent border-b-2 border-gray-300 focus:border-blue-500 w-full outline-none"
...
<div className="bg-white p-6 shadow-md rounded-lg mb-8">
  ...
  <textarea
    ...
    readOnly={!isEdit}
    className="w-full h-24 p-4 bg-gray-100 border-2 border-gray-300 rounded-lg focus:border-blue-500 outline-none"
...
<div className="bg-white p-6 shadow-md rounded-lg mb-8">
  ...
  {experiences.map((exp, index) => (
    <div key={index} className="bg-gray-100 p-4 mb-6 rounded-lg shadow-sm">
      <div className="flex flex-col lg:flex-row justify-between">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="text-lg font-semibold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none lg:w-1/4 mb-2 lg:mb-0"
          placeholder="Year"
        />
        <input
          value={exp.title}
          ...
          type="text"
          readOnly={!isEdit}
          className="text-xl font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none w-full lg:w-2/3 mb-2 lg:mb-0"
      ...
      <input
        ...
        type="text"
        readOnly={!isEdit}
        className="text-lg bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none w-full mb-4"
      ...
      <textarea
        ...
        name="description"
        readOnly={!isEdit}
        className="w-full h-20 p-3 bg-gray-50 border-2 border-gray-300 rounded-lg focus:border-blue-500 outline-none"
  ...
  {isEdit && (
    <div
      ...
      className="text-blue-700 cursor-pointer flex items-center mt-4"
    >
    ...
    {skills.map((skill, index) => (
      <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-sm">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="text-lg font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none w-full mb-2"
          placeholder="Skill"
        />
