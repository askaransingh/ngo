  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
         <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-md border border-gray-300"  id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <header className="text-center mb-10">
        <h1 className="text-6xl font-bold text-teal-600">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b border-teal-600 focus:border-teal-500"
            placeholder="Your Name"
          />
        </h1>
        <h2 className="text-2xl text-gray-800 mt-2 mb-4">
          <input
      ...
      <section className="mb-8">
        <h3 className="text-4xl font-semibold text-teal-600 mb-2">About Me</h3>
        <textarea
          value={formData.personalDescription}
          onChange={handleChange}
          name="personalDescription"
          readOnly={!isEdit}
          className="w-full h-32 p-4 border border-gray-300 rounded-lg focus:border-teal-500"
      ...
      <section className="mb-8">
        <h3 className="text-4xl font-semibold text-teal-600 mb-2">Work Experience</h3>
        {experiences.map((exp, index) => (
          <div key={index} className="mb-6 p-4 border border-gray-300 rounded-lg bg-gray-50">
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b border-teal-600 focus:border-teal-500 w-full mb-2"
              placeholder="Year"
            />
            <input
              value={exp.title}
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 border border-gray-300 rounded-lg focus:border-teal-500"
        ...
        {isEdit && (
          <div
            ...
            className="text-teal-600 cursor-pointer flex items-center mb-4"
          >
      ...
      {/* Skills Section */}
      <section>
        <h3 className="text-4xl font-semibold text-teal-600 mb-2">Skills</h3>
        {skills.map((skill, index) => (
          <div key={index} className="flex items-center justify-between mb-4 bg-gray-100 p-3 rounded-lg">
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b border-teal-600 focus:border-teal-500 w-full"
              placeholder="Skill"
            />
            {isEdit && (
              <FaTrash
        ...
        {isEdit && (
          <div
            onClick={addSkill}
            className="text-teal-600 cursor-pointer flex items-center"
          >
