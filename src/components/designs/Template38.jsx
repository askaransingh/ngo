      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
         <div className="w-full min-h-screen bg-gray-800 p-8 font-sans text-white" id="resume"
            ref={resumeRef}>
  ...
  <div className="flex flex-col lg:flex-row justify-between">
    <div className="lg:w-1/2">
      ...
      <input
        ...
        type="text"
        readOnly={!isEdit}
        className="text-lg text-gray-300 bg-transparent border-none focus:outline-none w-full mt-2"
        placeholder="Professional Title"
      />
    </div>
    <div className="lg:w-1/2 flex flex-col items-start lg:items-end mt-6 lg:mt-0">
      <input
      ...
      <input
        ...
        type="tel"
        readOnly={!isEdit}
        className="text-sm bg-transparent border-none focus:outline-none w-full mt-2"
...
{/* About Me Section */}
<div className="bg-gray-900 p-6 shadow-md rounded-lg mb-8">
  ...
  <textarea
    ...
    readOnly={!isEdit}
    className="w-full h-32 p-4 bg-transparent border border-gray-700 rounded-lg focus:border-blue-400"
    ...
    <div key={index} className="mb-6 bg-gray-800 p-4 rounded-lg">
      <div className="flex flex-col lg:flex-row justify-between">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="text-lg font-semibold bg-transparent border-none focus:outline-none w-full lg:w-1/4"
          placeholder="Year"
        />
        <input
          value={exp.title}
          ...
          type="text"
          readOnly={!isEdit}
          className="text-xl font-bold bg-transparent border-none focus:outline-none w-full lg:w-2/3 mt-2 lg:mt-0"
      ...
      <input
        ...
        type="text"
        readOnly={!isEdit}
        className="text-lg bg-transparent border-none focus:outline-none w-full mt-2"
      ...
      <textarea
        ...
        name="description"
        readOnly={!isEdit}
        className="w-full h-24 p-4 bg-transparent border border-gray-700 rounded-lg focus:border-blue-400 mt-4"
    ...
    {skills.map((skill, index) => (
      <div key={index} className="bg-gray-800 p-4 rounded-lg">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="text-lg font-bold bg-transparent border-none focus:outline-none w-full"
          placeholder="Skill"
        />
        <div className="bg-gray-600 h-4 rounded-lg mt-2 w-full">
          <div
        ...
        {isEdit && (
          <input
            ...
            type="number"
            readOnly={!isEdit}
            className="mt-2 bg-transparent border-none focus:outline-none w-full"
