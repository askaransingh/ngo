  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
             <div className="max-w-4xl mx-auto p-10 bg-white rounded-lg shadow-lg border border-gray-200"  id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold text-blue-800 mb-2">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-blue-800 focus:border-blue-500"
      ...
      <section className="mb-8">
        <h3 className="text-2xl font-semibold text-blue-800 mb-2">About Me</h3>
        <textarea
          value={formData.personalDescription}
          onChange={handleChange}
          name="personalDescription"
          readOnly={!isEdit}
          className="w-full h-32 p-4 border border-gray-300 rounded-lg focus:border-blue-500"
      ...
      <section className="mb-8">
        <h3 className="text-2xl font-semibold text-blue-800 mb-2">Work Experience</h3>
        {experiences.map((exp, index) => (
          <div key={index} className="mb-6 p-4 border border-gray-300 rounded-lg bg-gray-100">
            <input
              value={exp.year}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-blue-800 focus:border-blue-500 w-full mb-2"
              placeholder="Year"
            />
            <input
              value={exp.title}
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 border border-gray-300 rounded-lg focus:border-blue-500"
      ...
      {/* Skills Section */}
      <section>
        <h3 className="text-2xl font-semibold text-blue-800 mb-2">Skills</h3>
        {skills.map((skill, index) => (
          <div key={index} className="flex items-center justify-between mb-4 bg-gray-200 p-3 rounded-lg">
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-blue-800 focus:border-blue-500 w-full"
              placeholder="Skill"
            />
            {isEdit && (
              <FaTrash
