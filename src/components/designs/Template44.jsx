      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
    <div className="max-w-4xl mx-auto p-10 bg-gray-100 rounded-lg shadow-lg border border-gray-300"  id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <header className="flex flex-col items-center mb-8">
        <h1 className="text-5xl font-bold text-indigo-700 mb-1">
          <input
            value={formData.name}
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-indigo-700 focus:border-indigo-500 w-full text-center"
        ...
        <div className="flex justify-center space-x-4 mb-4">
          <input
            ...
            type="email"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-indigo-700 focus:border-indigo-500 text-center"
            placeholder="Email"
          />
          <input
      ...
      <section className="mb-6">
        <h3 className="text-2xl font-semibold text-indigo-700 mb-2">About Me</h3>
        <textarea
          value={formData.personalDescription}
          onChange={handleChange}
          name="personalDescription"
          readOnly={!isEdit}
          className="w-full h-32 p-3 border border-gray-400 rounded-lg focus:border-indigo-500 outline-none"
      ...
      <section className="mb-6">
        <h3 className="text-2xl font-semibold text-indigo-700 mb-2">Work Experience</h3>
        {experiences.map((exp, index) => (
          <div key={index} className="mb-4 p-4 border border-gray-300 rounded-lg shadow-sm bg-white">
            <input
              value={exp.year}
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-indigo-700 focus:border-indigo-500 w-full mb-2"
              placeholder="Year"
            />
            <input
              value={exp.title}
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 border border-gray-400 rounded-lg focus:border-indigo-500 outline-none"
        ...
        {isEdit && (
          <div
            ...
            className="text-indigo-500 cursor-pointer flex items-center"
          >
      ...
      {/* Skills Section */}
      <section>
        <h3 className="text-2xl font-semibold text-indigo-700 mb-2">Skills</h3>
        {skills.map((skill, index) => (
          <div key={index} className="flex items-center justify-between mb-4 bg-gray-200 p-2 rounded-lg">
