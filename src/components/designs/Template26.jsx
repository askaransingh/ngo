      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
     <div className="w-full h-auto bg-gray-100 text-gray-800 p-10"  id="resume"
            ref={resumeRef}>
      {/* Top Section */}
      <div className="w-full flex justify-between items-center bg-white p-6 rounded-md shadow-md">
        <div className="w-1/2">
          <input
            value={formData.name}
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-4xl font-bold outline-none border-none w-full mb-2"
          />
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-xl text-gray-600 w-full outline-none border-none"
          />
        </div>
        <div className="w-1/2 text-right">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-md text-gray-500 outline-none border-none mb-2"
          />
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-md text-gray-500 outline-none border-none"
          />
        </div>
      </div>
      ...
      <div className="w-full mt-10">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          rows="4"
          className="w-full mt-4 p-4 bg-white shadow-md rounded-md outline-none border-none"
        ></textarea>
      </div>
      ...
      <div className="w-full mt-10">
        ...
        <AnimatePresence>
          {experiences.map((exp, i) => (
            <motion.div
              key={i}
              className="flex mt-4 bg-white p-4 shadow-md rounded-md"
              {...opacityINOut(i)}
            >
              <div className="w-1/3">
                <input
                  ...
                  type="text"
                  readOnly={!isEdit}
                  className="w-full bg-transparent outline-none border-none text-md"
                />
              </div>
              <div className="w-2/3">
                {isEdit && (
