    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
      <div className="w-full h-auto bg-gray-50 p-8 font-sans"  id="resume"
            ref={resumeRef}>
      
      {/* Header Section */}
      <div className="bg-blue-800 text-white p-6 rounded-lg shadow-lg mb-8">
        <div className="flex flex-col items-center space-y-4 lg:space-y-0 lg:space-x-6 lg:flex-row">
          <div className="flex-1 text-center lg:text-left">
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-3xl font-semibold bg-transparent border-b-2 border-white focus:border-yellow-400 w-full text-center lg:text-left"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-lg text-yellow-400 bg-transparent border-b-2 border-gray-500 focus:border-yellow-400 w-full text-center lg:text-left mt-1"
          ...
          <div className="flex-1 space-y-2 text-center lg:text-right">
            <input
              ...
              type="email"
              readOnly={!isEdit}
              className="text-sm bg-transparent border-b-2 border-white focus:border-yellow-400 w-full"
              placeholder="Email"
            />
            <input
      ...
      <div className="bg-white p-8 shadow-lg rounded-lg mb-8">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          className="w-full h-32 p-4 bg-gray-100 border-2 border-gray-300 rounded-lg focus:border-blue-400 outline-none"
      ...
      <div className="bg-white p-8 shadow-lg rounded-lg mb-8">
          ...
          <div key={index} className="bg-gray-100 p-4 mb-6 rounded-lg shadow-sm">
            <div className="flex flex-col lg:flex-row justify-between items-center">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-semibold bg-transparent border-b-2 border-gray-500 focus:border-blue-400 outline-none w-full lg:w-1/4 mb-2 lg:mb-0"
                placeholder="Year"
              />
              <input
                value={exp.title}
                ...
                type="text"
                readOnly={!isEdit}
                className="text-xl font-bold bg-transparent border-b-2 border-gray-500 focus:border-blue-400 outline-none w-full lg:w-2/3 mb-2 lg:mb-0"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-lg bg-transparent border-b-2 border-gray-500 focus:border-blue-400 outline-none w-full mb-4"
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 bg-gray-100 border-2 border-gray-300 rounded-lg focus:border-blue-400 outline-none"
        ...
        {isEdit && (
          <div
            ...
            className="text-blue-400 cursor-pointer flex items-center mt-4"
          >
          ...
          {skills.map((skill, index) => (
            <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-sm">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-bold bg-transparent border-b-2 border-gray-500 focus:border-blue-400 outline-none w-full mb-2"
                placeholder="Skill"
              />
              ...
              {isEdit && (
                <input
                  ...
                  type="number"
                  readOnly={!isEdit}
                  className="text-lg mt-2 bg-transparent border-b-2 border-gray-500 focus:border-blue-400 outline-none"
