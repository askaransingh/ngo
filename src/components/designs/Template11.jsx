      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
            <div className="bg-gradient-to-r from-blue-200 to-blue-500 p-6 rounded-lg shadow-lg" id="resume"
            ref={resumeRef}>
      <div className="bg-white p-4 rounded-lg shadow-md">
        <div className="flex flex-col items-start">
          ...
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-blue-700">About Me</p>
            <textarea
              readOnly={!isEdit}
              className={`w-full p-2 border rounded-lg text-gray-600 ${isEdit ? "bg-gray-100" : "bg-white"}`}
          ...
          {/* Experience */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-blue-700">Work Experience</p>
            <div className="mt-4">
              <AnimatePresence>
                {experiences.map((exp, i) => (
                  ...
                  >
                    <textarea
                      ...
                      name="year"
                      readOnly={!isEdit}
                      className={`w-1/4 p-2 border rounded-lg text-gray-600 ${isEdit ? "bg-gray-100" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
          ...
          {/* Skills */}
          <div className="w-full mt-6">
            <p className="uppercase text-xl font-semibold text-blue-700">Skills</p>
                ...
                {skills.map((skill, i) => (
                  <motion.div key={i} className="flex items-center w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    <textarea
                      ...
                      name="title"
                      readOnly={!isEdit}
                      className={`flex-1 p-2 border rounded-lg text-gray-600 ${isEdit ? "bg-gray-100" : "bg-white"}`}
                      style={{ resize: "none" }}
                    />
                    <textarea
