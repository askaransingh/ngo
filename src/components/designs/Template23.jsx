...
const Template1 = ({}) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
          <div className="w-full h-auto bg-gray-100 text-gray-900 p-10" id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <div className="grid grid-cols-2 gap-6">
        ...
        <div>
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className={`text-4xl font-bold bg-transparent outline-none w-full ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
        ...
        <div>
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className={`text-xl font-medium bg-transparent outline-none w-full text-right ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
      ...
      <div className="grid grid-cols-2 gap-6 mt-4">
        <div>
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className={`text-sm bg-transparent outline-none w-full ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
        ...
        <div>
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className={`text-sm bg-transparent outline-none w-full text-right ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
            placeholder="Your Address, City, ZIP"
          />
        </div>
      </div>
      ...
      {/* About Me Section */}
      <div className="mt-8">
        <p className="text-lg font-semibold uppercase mb-2">About Me</p>
        <textarea
          readOnly={!isEdit}
          className={`w-full bg-transparent outline-none border border-gray-300 p-2 rounded ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
      ...
      <div className="mt-8">
        <p className="text-lg font-semibold uppercase mb-2">Work Experience</p>
          ...
          <AnimatePresence>
            {experiences &&
              experiences.map((exp, i) => (
                <motion.div
                  {...opacityINOut(i)}
                  className="w-full flex justify-between items-start mb-4 bg-white p-4 shadow-md rounded"
                  key={i}
                >
                  <div className="w-1/4">
                    <input
                      ...
                      type="text"
                      readOnly={!isEdit}
                      className={`outline-none bg-transparent w-full ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
                      placeholder="Year"
                    />
                  </div>
                  <div className="w-3/4">
                    <input
                      ...
                      type="text"
                      readOnly={!isEdit}
                      className={`text-lg font-semibold bg-transparent outline-none w-full ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
                    ...
                    <input
                      ...
                      type="text"
                      readOnly={!isEdit}
                      className={`text-sm bg-transparent outline-none w-full mt-1 ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
                      placeholder="Company, Location"
                    />
                    <textarea
                      readOnly={!isEdit}
                      className={`text-sm bg-transparent outline-none w-full mt-3 ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
                      name="description"
            ...
            {isEdit && (
              <motion.div
                ...
                className="cursor-pointer mt-2 text-green-500"
              >
                <FaPlus />
              </motion.div>
            )}
      ...
      {/* Skills Section */}
      <div className="mt-8">
        <p className="text-lg font-semibold uppercase mb-2">Skills</p>
        <div className="grid grid-cols-2 gap-6">
          <AnimatePresence>
            {skills &&
              skills.map((skill, i) => (
                <motion.div
                  {...opacityINOut(i)}
                  key={i}
                  className="w-full flex justify-between items-center bg-white p-4 shadow-md rounded mb-4"
                >
                  <input
                    value={skill.title}
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className={`text-sm font-semibold bg-transparent outline-none w-2/3 ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
                    placeholder="Skill"
                  />
                  <input
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className={`text-sm bg-transparent outline-none w-1/3 text-right ${isEdit ? "bg-gray-200" : "bg-transparent"}`}
                    placeholder="%"
                  />
                  {isEdit && (
                    <FaTrash
