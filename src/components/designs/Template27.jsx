    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
         <div className="w-full min-h-screen bg-gray-900 text-gray-100 p-8"id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-gray-800 p-6 rounded-lg shadow-lg">
        <div className="w-full md:w-1/2 mb-4 md:mb-0">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-4xl font-bold text-white outline-none border-none w-full mb-2"
          />
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-xl text-gray-400 w-full outline-none border-none"
          />
        </div>
        <div className="w-full md:w-1/2 text-left md:text-right">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-md text-gray-400 outline-none border-none mb-2"
          />
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-md text-gray-400 outline-none border-none"
          />
        </div>
      </div>
      ...
      <div className="w-full mt-10">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          rows="5"
          className="w-full mt-4 p-4 bg-gray-800 text-white shadow-lg rounded-lg outline-none border-none"
        ></textarea>
      </div>

      {/* Work Experience Section */}
      <div className="w-full mt-10">
        <h2 className="text-3xl font-semibold text-teal-400">Work Experience</h2>
        <AnimatePresence>
          {experiences.map((exp, i) => (
            <motion.div
              key={i}
              className="flex mt-6 bg-gray-800 p-6 shadow-lg rounded-lg"
              {...opacityINOut(i)}
            >
              <div className="w-1/4 pr-4">
                <input
                  ...
                  type="text"
                  readOnly={!isEdit}
                  className="w-full bg-transparent text-white text-md outline-none border-none"
                />
              </div>
              <div className="w-3/4 relative">
                ...
                <input
                  ...
                  type="text"
                  readOnly={!isEdit}
                  className="w-full bg-transparent text-lg font-semibold text-white outline-none border-none"
                />
                <input
                  ...
                  type="text"
                  readOnly={!isEdit}
                  className="w-full bg-transparent text-md text-gray-400 outline-none border-none mt-1"
                />
                <textarea
                  ...
                  readOnly={!isEdit}
                  rows="3"
                  className="w-full bg-transparent text-gray-400 outline-none border-none mt-2"
                ></textarea>
              </div>
            </motion.div>
          ))}
        ...
        {isEdit && (
          <div
            ...
            className="cursor-pointer w-full text-center py-3"
          >
            <FaPlus className="text-base text-teal-400" />
          </div>
        )}
      </div>
        ...
        <div className="grid grid-cols-2 gap-6 mt-6">
          <AnimatePresence>
            {skills.map((skill, i) => (
              <motion.div
                key={i}
                className="w-full bg-gray-800 p-6 shadow-lg rounded-lg"
                {...opacityINOut(i)}
              >
                <input
                  value={skill.title}
                ...
                {isEdit && (
                  <input
                    ...
                    name="percentage"
                    type="text"
                    className="w-full bg-transparent text-md text-gray-400 outline-none border-none mt-2"
                  />
                )}
                {isEdit && (
                  <motion.div
