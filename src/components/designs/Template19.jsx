    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
          <div className="bg-white p-12" id="resume"
            ref={resumeRef}>
      {/* Header Section */}
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-7">
            ...
            <input
              ...
              readOnly={!isEdit}
              className={`text-4xl font-bold text-gray-800 w-full p-2 bg-white ${
                isEdit ? "bg-gray-50" : "bg-transparent"
              } border-b border-gray-300`}
            />

            {/* Editable Professional Title */}
            <input
              type="text"
              ...
              onChange={handleChange}
              readOnly={!isEdit}
              className={`text-lg text-gray-600 w-full mt-2 p-2 bg-white ${
                isEdit ? "bg-gray-50" : "bg-transparent"
              } border-b border-gray-300`}
            />
          </div>
          ...
          <div className="col-span-5 text-right">
            ...
            <input
              ...
              onChange={handleChange}
              readOnly={!isEdit}
              className={`text-gray-600 w-full mb-2 p-2 bg-white ${
                isEdit ? "bg-gray-50" : "bg-transparent"
              } border-b border-gray-300`}
            />
      ...
      <div className="my-8">
        <div className="bg-gray-100 p-6 shadow-md rounded-lg">
          ...
          <textarea
            readOnly={!isEdit}
            className={`w-full text-gray-700 p-4 rounded-lg border border-gray-300 bg-white ${
              isEdit ? "bg-gray-50" : "bg-transparent"
            }`}
      ...
      <div className="my-8">
        <div className="bg-gray-100 p-6 shadow-md rounded-lg">
            ...
            {skills.map((skill, i) => (
              <motion.div key={i} className="flex items-center justify-between">
                <input
                  ...
                  type="text"
                  readOnly={!isEdit}
                  className={`w-full text-gray-700 p-3 rounded-lg border border-gray-300 bg-white ${
                    isEdit ? "bg-gray-50" : "bg-transparent"
                  }`}
                />
                <input
                  ...
                  type="text"
                  readOnly={!isEdit}
                  className={`ml-4 w-1/4 text-gray-700 p-3 rounded-lg border border-gray-300 bg-white ${
                    isEdit ? "bg-gray-50" : "bg-transparent"
                  }`}
                />
                {isEdit && (
                  <div onClick={() => removeSkill(i)} className="ml-4 text-gray-600 cursor-pointer">
                    <FaTrash />
                  </div>
                )}
              </motion.div>
          ...
          {isEdit && (
            <div onClick={addSkill} className="mt-4 text-gray-600 cursor-pointer flex items-center">
      ...
      <div className="my-8">
        <div className="bg-gray-100 p-6 shadow-md rounded-lg">
          ...
          {experiences.map((exp, i) => (
            <motion.div key={i} className="my-4">
              <div className="grid grid-cols-12 gap-4">
                ...
                <div className="col-span-8">
                  ...
                  <input
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className={`w-full mt-2 text-gray-700 p-3 rounded-lg border border-gray-300 bg-white ${
                      isEdit ? "bg-gray-50" : "bg-transparent"
                    }`}
                  />
                  <textarea
                  ...
                  />
                  {isEdit && (
                    <div onClick={() => removeExperience(i)} className="mt-2 text-gray-600 cursor-pointer">
                      <FaTrash />
                    </div>
                  )}
                </div>
          ...
          {isEdit && (
            <div onClick={addExperience} className="mt-4 text-gray-600 cursor-pointer flex items-center">
