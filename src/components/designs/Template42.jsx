  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
           <div className="flex flex-col items-center w-full h-auto p-8 bg-gray-100 font-sans rounded-lg shadow-xl"id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      <div className="text-center mb-8">
        <h1 className="text-5xl font-bold text-blue-700 mb-2">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-blue-700 focus:border-blue-500 w-full"
        ...
        <div className="flex justify-center space-x-4 mb-4">
          <input
            ...
            type="email"
            readOnly={!isEdit}
            className="bg-transparent border-b-2 border-blue-700 focus:border-blue-500"
            placeholder="Email"
          />
          <input
      ...
      <div className="bg-white p-6 mb-6 w-full border border-gray-300 rounded-lg shadow-md">
        <h3 className="text-3xl font-semibold text-blue-700 mb-4">About Me</h3>
        <textarea
      ...
      <div className="bg-white p-6 mb-6 w-full border border-gray-300 rounded-lg shadow-md">
        <h3 className="text-3xl font-semibold text-blue-700 mb-4">Work Experience</h3>
          ...
          <div key={index} className="mb-5 p-4 border border-gray-200 rounded-lg shadow-sm">
            <div className="flex flex-col lg:flex-row justify-between items-center mb-2">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="bg-transparent border-b-2 border-blue-700 focus:border-blue-500 w-full lg:w-1/4 mb-2 lg:mb-0"
                placeholder="Year"
              />
              <input
                value={exp.title}
                ...
                type="text"
                readOnly={!isEdit}
                className="bg-transparent border-b-2 border-blue-700 focus:border-blue-500 w-full lg:w-2/3"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="bg-transparent border-b-2 border-blue-700 focus:border-blue-500 w-full mb-2"
      ...
      <div className="bg-white p-6 border border-gray-300 rounded-lg shadow-md w-full">
        <h3 className="text-3xl font-semibold text-blue-700 mb-4">Skills</h3>
