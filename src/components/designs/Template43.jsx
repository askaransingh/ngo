    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-gray-300" id="resume"
            ref={resumeRef}>
      {/* Header Section */}
      ...
      <section className="mb-6">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          className="w-full h-32 p-3 border border-gray-400 rounded-lg focus:border-blue-500 outline-none"
        ...
        {experiences.map((exp, index) => (
          <div key={index} className="mb-4 p-4 border border-gray-300 rounded-lg shadow-sm">
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 border border-gray-400 rounded-lg focus:border-blue-500 outline-none"
