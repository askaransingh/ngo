      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
        <div className="w-full h-auto bg-gray-200 p-8" id="resume"
            ref={resumeRef}>

{/* Header Section */}
<div className="w-full flex flex-col md:flex-row justify-between bg-white p-6 shadow-lg rounded-lg space-y-6 md:space-y-0">
  <div className="w-full md:w-1/2 space-y-4">
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="text-4xl font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 w-full outline-none"
    ...
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="text-xl text-blue-600 bg-transparent border-b-2 border-gray-300 focus:border-blue-500 w-full outline-none"
  ...
  <div className="w-full md:w-1/2 flex flex-col space-y-2">
    <input
      ...
      type="email"
      readOnly={!isEdit}
      className="text-lg bg-transparent border-b-2 border-gray-300 focus:border-blue-500 w-full outline-none"
...
<div className="w-full bg-white p-6 shadow-lg rounded-lg mt-6">
  ...
  <textarea
    ...
    readOnly={!isEdit}
    className="w-full h-32 p-4 bg-gray-100 border-2 border-gray-300 rounded-lg focus:border-blue-500 outline-none"
...
<div className="w-full bg-white p-6 shadow-lg rounded-lg mt-6">
  <h2 className="text-3xl font-bold text-blue-700 mb-4">Work Experience</h2>
  {experiences.map((exp, index) => (
    <div
      key={index}
      className="flex flex-col lg:flex-row justify-between bg-gray-100 p-4 rounded-lg mb-4 shadow-md"
    >
      ...
      <div className="w-full lg:w-3/4 space-y-2">
        ...
        <textarea
          ...
          name="description"
          readOnly={!isEdit}
          className="w-full h-24 bg-gray-200 p-4 rounded-lg border-2 border-gray-300 focus:border-blue-500 outline-none"
...
{/* Skills Section */}
<div className="w-full bg-white p-6 shadow-lg rounded-lg mt-6">
  <h2 className="text-3xl font-bold text-blue-700 mb-4">Skills</h2>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {skills.map((skill, index) => (
      <div
        key={index}
        className="bg-gray-100 p-4 rounded-lg shadow-md flex flex-col relative"
      >
        <input
          value={skill.title}
