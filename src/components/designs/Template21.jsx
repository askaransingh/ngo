  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          > */}
            ...
            ref={resumeRef}>
      {/* Resume Header */}
      <div className="w-full flex flex-col items-center justify-center gap-8 py-10 bg-gray-100">
        <div className="w-3/4 text-center">
          ...
          <input
            ...
            type="text"
            readOnly={true}
            className={`text-4xl font-bold tracking-widest bg-transparent outline-none border-none w-full ${
              isEdit ? "text-black bg-gray-200" : "text-black"
            }`}
          />
        </div>
        {/* Professional Title */}
        <div className="w-3/4 text-center">
          <input
            ...
            type="text"
            readOnly={true}
            className={`text-xl tracking-widest bg-transparent outline-none border-none w-full ${
              isEdit ? "text-black bg-gray-200" : "text-gray-500"
            }`}
          />
        </div>
        {/* Contact Info */}
        <div className="w-3/4 text-center">
          <input
            ...
            type="text"
            readOnly={true}
            className={`text-base tracking-wider bg-transparent outline-none border-none w-full ${
              isEdit ? "text-black bg-gray-200" : "text-gray-500"
            }`}
          />
          <input
      ...
      <div className="w-full flex flex-col items-start justify-start px-8 py-6">
        <p className="text-2xl tracking-wide uppercase">About Me</p>
        <textarea
          readOnly={true}
          className={`text-base bg-transparent outline-none border-none w-full mt-3 ${
      ...
      <div className="w-full flex flex-col items-start justify-start px-8 py-6">
        <p className="text-2xl tracking-wide uppercase">Work Experience</p>
        <div className="w-full mt-4">
          <AnimatePresence>
                ...
                >
                  ...
                  <div className="w-3/4">
                    <input
                      ...
                      type="text"
                      readOnly={true}
                      className={`text-lg font-semibold bg-transparent outline-none border-none w-full ${
                        isEdit ? "bg-gray-200" : "bg-transparent"
                      }`}
                    />
                    <input
                      ...
                      type="text"
                      readOnly={true}
                      className={`text-base bg-transparent outline-none border-none w-full mt-1 ${
                        isEdit ? "bg-gray-200" : "bg-transparent"
                      }`}
                    />
                    <textarea
                    ...
                    {isEdit && (
                      <FaTrash
                        className="cursor-pointer text-txtPrimary"
            ...
            {isEdit && (
              ...
              >
                <FaPlus className="text-txtPrimary" />
              </motion.div>
            )}
          </AnimatePresence>
        </div>
      ...
      {/* Skills Section */}
      <div className="w-full flex flex-col items-start justify-start px-8 py-6">
        <p className="text-2xl tracking-wide uppercase">Skills</p>
              ...
              skills.map((skill, i) => (
                ...
                >
                  <input
                    ...
                    type="text"
                    readOnly={true}
                    className={`text-lg font-semibold bg-transparent outline-none border-none w-2/3 ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                  />
                  <input
                    ...
                    type="text"
                    readOnly={true}
                    className={`text-lg bg-transparent outline-none border-none w-1/3 ${
                      isEdit ? "bg-gray-200" : "bg-transparent"
                    }`}
                  />
                  {isEdit && (
