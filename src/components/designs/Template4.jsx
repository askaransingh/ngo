...
const Template4 = ({ data = {} }) => {
  ...
  const handleAboutMeChange = (e) => {
    setAboutMe(e.target.value); // Update state with the new value
  };
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full min-h-screen bg-white p-8"id="resume"
            ref={resumeRef}>
      <div className="w-full max-w-3xl mx-auto">
        <div className="w-full">
          ...
          <div className="w-full mb-8">
            ...
            <div className="w-full h-1 bg-gray-400 my-3"></div>
            <textarea
              value={aboutMe}
              onChange={handleAboutMeChange} // Pass new value to handler
              readOnly={!isEdit} // Editable only when isEdit is true
              className={`outline-none border-none text-base tracking-wide font-semibold text-txtPrimary w-full ${
                      ...
                      <div className="w-full flex items-center justify-between">
                        <div className="flex items-center justify-center">
                          <input
                            ...
                            name="title"
                            type="text"
                            readOnly={!isEdit} // Readonly unless in edit mode
