...
const Template1 = ({}) => {
  ...
  return (
   ...
   <div className="w-full h-auto bg-gray-100 p-10 font-sans" id="resume"
      ...
      {/* Header Section */}
      <div className="flex flex-col lg:flex-row bg-gray-900 text-white p-8 shadow-lg rounded-lg mb-8 space-y-6 lg:space-y-0 lg:space-x-8">
        <div className="flex-1 space-y-4">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="text-4xl font-bold bg-transparent border-b-2 border-white focus:border-yellow-400 w-full outline-none"
          ...
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="text-lg text-yellow-400 bg-transparent border-b-2 border-gray-500 focus:border-yellow-400 w-full outline-none"
        ...
        <div className="flex-1 space-y-2">
          <input
            ...
            type="email"
            readOnly={!isEdit}
            className="text-sm bg-transparent border-b-2 border-white focus:border-yellow-400 w-full outline-none"
            placeholder="Email"
          />
          <input
      ...
      <div className="bg-white p-8 shadow-lg rounded-lg mb-8">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          className="w-full h-32 p-4 bg-gray-100 border-2 border-gray-300 rounded-lg focus:border-yellow-400 outline-none"
      ...
      <div className="bg-white p-8 shadow-lg rounded-lg mb-8">
          ...
          <div key={index} className="bg-gray-100 p-4 mb-6 rounded-lg shadow-sm">
            <div className="flex flex-col lg:flex-row justify-between items-center">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-semibold bg-transparent border-b-2 border-gray-500 focus:border-yellow-400 outline-none w-full lg:w-1/4 mb-2 lg:mb-0"
                placeholder="Year"
              />
              <input
                value={exp.title}
                ...
                type="text"
                readOnly={!isEdit}
                className="text-xl font-bold bg-transparent border-b-2 border-gray-500 focus:border-yellow-400 outline-none w-full lg:w-2/3 mb-2 lg:mb-0"
            ...
            <input
              ...
              type="text"
              readOnly={!isEdit}
              className="text-lg bg-transparent border-b-2 border-gray-500 focus:border-yellow-400 outline-none w-full mb-4"
            ...
            <textarea
              ...
              name="description"
              readOnly={!isEdit}
              className="w-full h-24 p-3 bg-gray-100 border-2 border-gray-300 rounded-lg focus:border-yellow-400 outline-none"
        ...
        {isEdit && (
          <div
            ...
            className="text-yellow-400 cursor-pointer flex items-center mt-4"
          >
          ...
          {skills.map((skill, index) => (
            <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-sm">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="text-lg font-bold bg-transparent border-b-2 border-gray-500 focus:border-yellow-400 outline-none w-full mb-2"
                placeholder="Skill"
              />
              ...
              {isEdit && (
                <input
                  ...
                  type="number"
                  readOnly={!isEdit}
                  className="text-lg mt-2 bg-transparent border-b-2 border-gray-500 focus:border-yellow-400 outline-none"
