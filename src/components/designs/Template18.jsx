      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
             <div className="bg-white p-8"   id="resume"
            ref={resumeRef}>
      <div className="bg-gray-100 rounded-lg p-6 shadow-md">
        <h1 className="text-3xl font-bold text-gray-800 uppercase">{formData.name}</h1>
        <h2 className="text-xl text-gray-600 italic">{formData.professionalTitle}</h2>
        ...
        <div className="my-6">
          ...
          <textarea
            readOnly={!isEdit}
            className={`w-full bg-gray-200 text-gray-800 p-2 rounded-md outline-none border-none ${isEdit ? "bg-gray-300" : "bg-transparent"}`}
        ...
        <div className="my-6">
          ...
          {experiences.map((exp, i) => (
            <motion.div className="grid grid-cols-12 my-4" key={i}>
              ...
              <div className="col-span-8">
                ...
                />
                {isEdit && (
                  <div onClick={() => removeExperience(i)} className="cursor-pointer text-gray-600">
                    <FaTrash />
                  </div>
                )}
              </div>
          ...
          {isEdit && (
            <div onClick={addExperience} className="cursor-pointer text-gray-600">
              <FaPlus />
            </div>
          )}
        </div>
          ...
          {skills.map((skill, i) => (
            <motion.div className="flex items-center justify-between my-2" key={i}>
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className={`w-4/12 bg-gray-200 text-gray-800 p-2 rounded-md outline-none border-none ${isEdit ? "bg-gray-300" : "bg-transparent"}`}
              />
              <input
              ...
              />
              {isEdit && (
                <div onClick={() => removeSkill(i)} className="cursor-pointer text-gray-600">
                  <FaTrash />
                </div>
              )}
              <div className="relative w-full h-1 bg-gray-300 mt-2">
                <div className="h-full bg-gray-400" style={{ width: `${skill.percentage}%`, transition: "width 0.3s ease" }}></div>
              </div>
            </motion.div>
          ))}
          {isEdit && (
            <div onClick={addSkill} className="cursor-pointer text-gray-600">
              <FaPlus />
            </div>
          )}
        </div>
