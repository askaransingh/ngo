...
const Template1 = ({}) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
          <div className="w-full h-auto bg-white text-black" id="resume"
            ref={resumeRef}>
      {/* Header */}
      <div className="w-full h-auto bg-gray-100 flex justify-center items-center py-10">
        <div className="text-center">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-3xl font-bold text-black w-full text-center outline-none border-none"
          />
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-xl text-gray-700 w-full text-center outline-none border-none mt-2"
          />
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-md text-gray-500 w-full text-center outline-none border-none mt-1"
          />
          <input
      ...
      {/* About Me */}
      <div className="w-full px-10 py-8 bg-gray-50">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          rows="4"
          className="w-full bg-transparent text-gray-700 outline-none border-none"
        ></textarea>
      </div>
        ...
        <div className="w-full flex flex-col gap-4">
          <AnimatePresence>
            {experiences.map((exp, i) => (
              <motion.div key={i} className="w-full flex gap-4" {...opacityINOut(i)}>
                <div className="w-1/3">
                  <input
                    value={exp.year}
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className="w-full bg-transparent text-md outline-none border-none"
                  />
                </div>
                <div className="w-2/3">
                  {isEdit && (
                    <motion.div onClick={() => removeExperience(i)} className="cursor-pointer absolute right-0 top-2">
                  ...
                  <input
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className="w-full bg-transparent text-lg font-semibold outline-none border-none"
                  />
                  <input
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className="w-full bg-transparent text-md outline-none border-none mt-1"
                  />
                  <textarea
                    ...
                    readOnly={!isEdit}
                    rows="3"
                    className="w-full bg-transparent text-gray-600 outline-none border-none mt-2"
                  ></textarea>
                </div>
              </motion.div>
            ))}
          ...
          {isEdit && (
            <div onClick={addExperience} className="cursor-pointer w-full text-center py-2">
              <FaPlus className="text-base text-gray-600" />
            </div>
          )}
        </div>
      </div>
      ...
      <div className="w-full px-10 py-8 bg-gray-50">
        ...
        <div className="w-full grid grid-cols-3 gap-4">
          <AnimatePresence>
            {skills.map((skill, i) => (
              <motion.div key={i} className="w-full" {...opacityINOut(i)}>
                <div className="w-full">
                  <input
                    ...
                    type="text"
                    readOnly={!isEdit}
                    className="w-full bg-transparent text-md font-semibold outline-none border-none"
                  />
                  {isEdit && (
                    <input
                  ...
                  {isEdit && (
                    <motion.div onClick={() => removeSkill(i)} className="cursor-pointer w-full text-right">
                      <FaTrash className="text-base text-red-500" />
                    </motion.div>
                  )}
                  <div className="w-full bg-gray-300 h-2 rounded-md mt-1">
                    <div className="h-full bg-black rounded-md" style={{ width: `${skill.percentage}%` }}></div>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          {isEdit && (
            <div onClick={addSkill} className="cursor-pointer w-full text-center py-2">
              <FaPlus className="text-base text-gray-600" />
            </div>
          )}
        </div>
