      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
      <div className="w-full h-auto bg-gray-100 p-10 font-sans"  id="resume"
            ref={resumeRef}>

{/* Header Section */}
<div className="w-full flex flex-col lg:flex-row justify-between items-center bg-white p-8 shadow-lg rounded-lg space-y-6 lg:space-y-0">
  <div className="lg:w-1/2 flex flex-col space-y-2 items-center lg:items-start">
    <input
      value={formData.name}
      ...
      type="text"
      readOnly={!isEdit}
      className="text-3xl font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 w-full lg:w-3/4 outline-none"
    ...
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="text-lg text-blue-600 bg-transparent border-b-2 border-gray-300 focus:border-blue-500 w-full lg:w-3/4 outline-none"
  ...
  <div className="lg:w-1/2 space-y-2">
    <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-4">
      <input
        ...
        type="email"
        readOnly={!isEdit}
        className="text-md bg-transparent border-b-2 border-gray-300 focus:border-blue-500 w-full lg:w-1/2 outline-none"
        placeholder="Email"
      />
      <input
    ...
    <input
      ...
      type="text"
      readOnly={!isEdit}
      className="text-md bg-transparent border-b-2 border-gray-300 focus:border-blue-500 w-full lg:w-3/4 outline-none"
      placeholder="Address"
    />
  </div>
</div>
...
{/* About Section */}
<div className="w-full bg-white p-8 shadow-lg rounded-lg mt-6">
  ...
  <textarea
    ...
    readOnly={!isEdit}
    className="w-full h-28 p-4 bg-gray-50 border-2 border-gray-300 rounded-lg focus:border-blue-500 outline-none"
...
<div className="w-full bg-white p-8 shadow-lg rounded-lg mt-6">
  ...
  {experiences.map((exp, index) => (
    <div
      key={index}
      className="bg-gray-100 p-6 rounded-lg mb-4 shadow-md flex flex-col lg:flex-row justify-between"
    >
      <div className="w-full lg:w-1/4 mb-4 lg:mb-0">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full text-lg font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none"
          placeholder="Year"
        />
      </div>
      <div className="w-full lg:w-3/4 space-y-2">
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full text-xl font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none"
        ...
        <input
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full text-lg bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none"
        ...
        <textarea
          ...
          name="description"
          readOnly={!isEdit}
          className="w-full h-20 bg-gray-50 p-3 border-2 border-gray-300 rounded-lg focus:border-blue-500 outline-none"
  ...
  {isEdit && (
    <div
      ...
      className="text-blue-600 cursor-pointer flex items-center mt-4"
    >
...
<div className="w-full bg-white p-8 shadow-lg rounded-lg mt-6">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
    {skills.map((skill, index) => (
      <div
        key={index}
        className="bg-gray-100 p-6 rounded-lg shadow-md flex flex-col relative"
      >
        <input
          value={skill.title}
          ...
          type="text"
          readOnly={!isEdit}
          className="w-full text-lg font-bold bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none mb-2"
          placeholder="Skill"
        />
        <div className="bg-gray-300 h-4 rounded-lg mt-2 w-full">
          <div
        ...
        {isEdit && (
          <input
            ...
            type="number"
            readOnly={!isEdit}
            className="text-lg mt-2 bg-transparent border-b-2 border-gray-400 focus:border-blue-500 outline-none"
