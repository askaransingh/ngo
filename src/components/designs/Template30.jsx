...
const Template1 = ({}) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          {/* <div
            ...
            ref={resumeRef}
          > */}
             <div className="w-full h-auto bg-gray-50 text-gray-900 p-8 space-y-10" id="resume"
            ref={resumeRef}>
      
      {/* Header Section */}
      <div className="w-full flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-6 lg:space-y-0 bg-white p-6 shadow-xl rounded-md">
        <div className="lg:w-2/3 w-full space-y-2">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-5xl font-bold w-full border-b-4 border-gray-300 focus:border-teal-500 outline-none mb-2"
          />
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-xl font-medium w-full text-teal-700 border-b-2 border-gray-300 focus:border-teal-500 outline-none"
          />
        </div>
        <div className="lg:w-1/3 w-full space-y-2">
          <input
            ...
            type="text"
            readOnly={!isEdit}
            className="bg-transparent text-lg w-full text-gray-500 border-b-2 border-gray-300 focus:border-teal-500 outline-none"
          />
          <input
      ...
      {/* About Section */}
      <div className="w-full bg-white p-6 shadow-xl rounded-md">
        ...
        <textarea
          ...
          readOnly={!isEdit}
          rows="4"
          className="w-full p-4 bg-gray-100 text-lg rounded-md border-2 border-gray-300 focus:border-teal-500 outline-none"
        ></textarea>
      </div>

      {/* Work Experience Section */}
      <div className="w-full bg-white p-6 shadow-xl rounded-md">
        <h2 className="text-2xl font-bold mb-4 text-teal-600">Work Experience</h2>
        {experiences.map((exp, i) => (
          <div key={i} className="w-full flex flex-col lg:flex-row space-y-4 lg:space-y-0 bg-gray-50 p-4 shadow-md rounded-md mb-4">
            <div className="lg:w-1/5 w-full">
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="w-full bg-transparent text-lg font-semibold text-teal-700 border-b-2 border-gray-300 focus:border-teal-500 outline-none"
              />
            </div>
            <div className="lg:w-4/5 w-full space-y-2 relative">
              {isEdit && (
                <FaTrash
              ...
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="w-full bg-transparent text-xl font-bold border-b-2 border-gray-300 focus:border-teal-500 outline-none"
              />
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className="w-full bg-transparent text-lg text-gray-500 border-b-2 border-gray-300 focus:border-teal-500 outline-none"
              />
              <textarea
                ...
                readOnly={!isEdit}
                rows="3"
                className="w-full bg-gray-100 p-4 text-gray-600 rounded-md border-2 border-gray-300 focus:border-teal-500 outline-none"
              ></textarea>
            </div>
          </div>
        ))}
        {isEdit && (
          <div
            ...
            className="cursor-pointer w-full text-center py-2 text-teal-600"
          >
      ...
      <div className="w-full bg-white p-6 shadow-xl rounded-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {skills.map((skill, i) => (
            <div key={i} className="bg-gray-50 p-4 shadow-md rounded-md relative">
              <input
                value={skill.title}
                ...
                type="text"
                readOnly={!isEdit}
                className="w-full bg-transparent text-lg font-semibold border-b-2 border-gray-300 focus:border-teal-500 outline-none mb-2"
              />
              ...
              {isEdit && (
                <input
                  ...
                  name="percentage"
                  type="text"
                  className="w-full bg-transparent text-lg font-semibold mt-2 border-b-2 border-gray-300 focus:border-teal-500 outline-none"
                />
              )}
              {isEdit && (
                <FaTrash
                  onClick={() => removeSkill(i)}
                  className="cursor-pointer text-red-500 absolute top-0 right-0"
                />
              )}
            </div>
          ))}
