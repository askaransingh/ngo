  ...
  return (
    <div className="templates-root__header templates-root__header--without-create-resume-button">
      ...
      <p className="templates-root__header-subtitle">
        Elevate your professional image with our unique creative resume templates,
        designed to highlight your creativity and set you apart in the job market.
      </p>
...
export default CreativeResumeHeader;